 ...
 */
add_action('widgets_init', 'pheromone_load_latest_post_widgets');

function pheromone_load_latest_post_widgets()
{
	register_widget('pheromone_Latest_Posts_Widget');
}
 ...
 *
 */
	class pheromone_Latest_Posts_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'pheromone_latest_post_widget',
			__( 'Pheromone: Latest Posts', 'pheromone' ),
			array(
				'classname' => 'pheromone_latest_post_widget',
				'description' => esc_html__( 'Displays latest posts from blog', 'pheromone' ),
...
function form( $instance ) {
	...
	$defaults = array( 'title' => __( 'Latest Posts' , 'pheromone' ), 'number_of_posts_to_show' => '3' );
