<?php
namespace WPvividProAws\S3\RegionalEndpoint;
...
use WPvividProAws\S3\RegionalEndpoint\Exception\ConfigurationException;
    ...
    implements ConfigurationProviderInterface
{
    ...
    public static function ini(
        ...
        return function () use ($profile, $filename) {
            ...
            $data = \WPvividProAws\parse_ini_file($filename, true);
            if ($data === false) {
