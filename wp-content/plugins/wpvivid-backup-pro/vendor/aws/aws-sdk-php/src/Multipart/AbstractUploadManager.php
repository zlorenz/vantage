<?php
namespace WPvividProAws\Multipart;

use WPvividProAws\AwsClientInterface as Client;
use WPvividProAws\CommandInterface;
use WPvividProAws\CommandPool;
use WPvividProAws\Exception\AwsException;
use WPvividProAws\Exception\MultipartUploadException;
use WPvividProAws\Result;
...
abstract class AbstractUploadManager implements Promise\PromisorInterface
{
    ...
    private static $defaultConfig = [
        ...
        'exception_class'     => 'WPvividProAws\Exception\MultipartUploadException',
    ];
