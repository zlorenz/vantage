...
use WPvividProAws\Api\Validator;
use WPvividProAws\Api\ApiProvider;
use WPvividProAws\Api\Service;
use WPvividProAws\ClientSideMonitoring\ApiCallAttemptMonitoringMiddleware;
use WPvividProAws\ClientSideMonitoring\ApiCallMonitoringMiddleware;
use WPvividProAws\ClientSideMonitoring\Configuration;
use WPvividProAws\Credentials\Credentials;
use WPvividProAws\Credentials\CredentialsInterface;
use WPvividProAws\Endpoint\PartitionEndpointProvider;
use WPvividProAws\Endpoint\UseFipsEndpoint\Configuration as UseFipsEndpointConfiguration;
use WPvividProAws\Endpoint\UseFipsEndpoint\ConfigurationProvider as UseFipsConfigProvider;
use WPvividProAws\Endpoint\UseFipsEndpoint\ConfigurationInterface as UseFipsEndpointConfigurationInterface;
use WPvividProAws\Endpoint\UseDualstackEndpoint\Configuration as UseDualStackEndpointConfiguration;
use WPvividProAws\Endpoint\UseDualstackEndpoint\ConfigurationProvider as UseDualStackConfigProvider;
use WPvividProAws\Endpoint\UseDualstackEndpoint\ConfigurationInterface as UseDualStackEndpointConfigurationInterface;
use WPvividProAws\EndpointDiscovery\ConfigurationInterface;
use WPvividProAws\EndpointDiscovery\ConfigurationProvider;
use WPvividProAws\Exception\InvalidRegionException;
use WPvividProAws\Retry\ConfigurationInterface as RetryConfigInterface;
use WPvividProAws\Retry\ConfigurationProvider as RetryConfigProvider;
use WPvividProAws\DefaultsMode\ConfigurationInterface as ConfigModeInterface;
use WPvividProAws\DefaultsMode\ConfigurationProvider as ConfigModeProvider;
use WPvividProAws\Signature\SignatureProvider;
use WPvividProAws\Endpoint\EndpointProvider;
use WPvividProGuzzleHttp\Promise\PromiseInterface;
use WPvividProAws\Credentials\CredentialProvider;
...
class ClientResolver
{
    ...
    private static $defaultArgs = [
        ...
        'exception_class' => [
            ...
            'default'  => 'WPvividProAws\Exception\AwsException',
            'internal' => true
        ],
        'scheme' => [
            'type'     => 'value',
        ...
        'csm' => [
            'type'     => 'value',
            'valid'    => [\WPvividProAws\ClientSideMonitoring\ConfigurationInterface::class, 'callable', 'array', 'bool'],
            ...
            'default'  => [\WPvividProAws\ClientSideMonitoring\ConfigurationProvider::class, 'defaultProvider']
        ],
        'http' => [
            'type'    => 'value',
            'valid'   => ['array'],
    ...
    public static function _apply_credentials($value, array &$args)
    {
        ...
        if ($value instanceof CredentialsInterface) {
            ...
            throw new IAE('Credentials must be an instance of '
                . 'WPvividProAws\Credentials\CredentialsInterface, an associative '
    ...
    public static function _apply_csm($value, array &$args, HandlerList $list)
    {
        if ($value === false) {
            $value = new Configuration(
                false,
                \WPvividProAws\ClientSideMonitoring\ConfigurationProvider::DEFAULT_HOST,
                \WPvividProAws\ClientSideMonitoring\ConfigurationProvider::DEFAULT_PORT,
                \WPvividProAws\ClientSideMonitoring\ConfigurationProvider::DEFAULT_CLIENT_ID
            );
            $args['csm'] = $value;
        }
    ...
    public static function _apply_endpoint_provider(callable $value, array &$args)
    {
        if (!isset($args['endpoint'])) {
            ...
            $args['region'] = \WPvividProAws\strip_fips_pseudo_regions($args['region']);
