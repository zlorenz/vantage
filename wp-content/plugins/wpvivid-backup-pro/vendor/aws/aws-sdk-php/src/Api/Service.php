...
use WPvividProAws\Api\Serializer\QuerySerializer;
use WPvividProAws\Api\Serializer\Ec2ParamBuilder;
use WPvividProAws\Api\Parser\QueryParser;
...
class Service extends AbstractModel
{
    ...
    {
        static $mapping = [
            'json'      => 'WPvividProAws\Api\Serializer\JsonRpcSerializer',
            'query'     => 'WPvividProAws\Api\Serializer\QuerySerializer',
            'rest-json' => 'WPvividProAws\Api\Serializer\RestJsonSerializer',
            'rest-xml'  => 'WPvividProAws\Api\Serializer\RestXmlSerializer'
        ];
    ...
    {
        static $mapping = [
            'json'      => 'WPvividProAws\Api\ErrorParser\JsonRpcErrorParser',
            'query'     => 'WPvividProAws\Api\ErrorParser\XmlErrorParser',
            'rest-json' => 'WPvividProAws\Api\ErrorParser\RestJsonErrorParser',
            'rest-xml'  => 'WPvividProAws\Api\ErrorParser\XmlErrorParser',
            'ec2'       => 'WPvividProAws\Api\ErrorParser\XmlErrorParser'
        ];
    ...
    {
        static $mapping = [
            'json'      => 'WPvividProAws\Api\Parser\JsonRpcParser',
            'query'     => 'WPvividProAws\Api\Parser\QueryParser',
            'rest-json' => 'WPvividProAws\Api\Parser\RestJsonParser',
            'rest-xml'  => 'WPvividProAws\Api\Parser\RestXmlParser'
        ];
