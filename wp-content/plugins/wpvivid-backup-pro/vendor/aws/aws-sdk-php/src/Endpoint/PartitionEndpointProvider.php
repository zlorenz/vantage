...
class PartitionEndpointProvider
{
    ...
    {
        $data = \WPvividProAws\load_compiled_json(__DIR__ . '/../data/endpoints.json');
        $prefixData = \WPvividProAws\load_compiled_json(__DIR__ . '/../data/endpoints_prefix_history.json');
