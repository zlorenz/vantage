<?php
namespace WPvividProAws\Endpoint\UseDualstackEndpoint;

use WPvividProAws\AbstractConfigurationProvider;
use WPvividProAws\CacheInterface;
use WPvividProAws\ConfigurationProviderInterface;
use WPvividProAws\Endpoint\UseDualstackEndpoint\Exception\ConfigurationException;
    ...
    implements ConfigurationProviderInterface
{
    ...
    public static function ini($region, $profile = null, $filename = null)
    {
        ...
        return function () use ($region, $profile, $filename) {
            ...
            $data = \WPvividProAws\parse_ini_file($filename, true, INI_SCANNER_NORMAL);
            if ($data === false) {
