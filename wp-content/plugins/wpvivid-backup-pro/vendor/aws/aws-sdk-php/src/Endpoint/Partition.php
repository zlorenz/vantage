<?php
namespace WPvividProAws\Endpoint;

use ArrayAccess;
use WPvividProAws\HasDataTrait;
use WPvividProAws\Sts\RegionalEndpoints\ConfigurationProvider;
use WPvividProAws\S3\RegionalEndpoint\ConfigurationProvider as S3ConfigurationProvider;
