...
use WPvividGuzzleHttp\Exception\InvalidArgumentException;
...
final class Utils
{
    ...
    public static function chooseHandler(): callable
    {
        ...
        if (\ini_get('allow_url_fopen')) {
            ...
            throw new \RuntimeException('WPvividGuzzleHttp requires cURL, the allow_url_fopen ini setting, or a custom HTTP handler.');
        }
    ...
    {
        return sprintf('WPvividGuzzleHttp/%d', ClientInterface::MAJOR_VERSION);
    }
