<?php
/**
 * Taxonomy Template: Video Formats (video-format)
 * File: taxonomy-video-format.php
 * Theme: vantagepictures-child
 */

get_header();

// Safety fallback if helper isn't loaded yet.
...
// Optional: exclude specific term IDs from the filter bar (ex: legacy/hidden)
$exclude_term_ids = [37]; // set [] if you don't want exclusions

// Build filter terms for the nav
