...
<div id="comments">
	...
	?>
		<h2 id="comments-title">
			<?php
				esc_html_e( 'No Comments yet!', 'vantagepictures' );
			?>
		</h2>
	<?php
		endif;
	...
	?>
		...
		<ol class="commentlist">
			<?php
				 ...
				 */
				wp_list_comments( array( 'callback' => 'vantagepictures_comment' ) );
			?>
		</ol>
		<?php
			if ( get_comment_pages_count() > 1 && get_option( 'page_comments' ) ) :
	...
	?>
		<h2 id="comments-title" class="nocomments"><?php esc_html_e( 'Comments are closed.', 'vantagepictures' ); ?></h2>
	<?php
		endif;
